...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    <article class="col-lg-9">
        ...
        <ul class=" list-unstyled d-flex gap-1">
            <li><a href="/dashboard/posts" class="d-flex align-items-center badge bg-info text-decoration-none"><i style="margin-right: 4px" data-feather="eye"></i>Back to posts</a></li>
